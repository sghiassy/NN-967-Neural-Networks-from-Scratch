...
# Dense Layer
class Layer_Dense:
    def __init__(self, input_count, neurons_count):
        self.weights = 0.01 * np.random.randn(input_count, neurons_count)
...
loss_activation = Activation_Softmax_Loss_CategroicalCrossEntropy()
